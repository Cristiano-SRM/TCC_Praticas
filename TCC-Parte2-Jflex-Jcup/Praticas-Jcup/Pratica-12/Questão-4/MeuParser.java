...
public class MeuParser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\004\000\002\002\004\000\002\002\016\000\002\002" +
    "\013\000\002\003\003" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\030\000\004\012\004\001\002\000\006\005\007\010" +
    "\010\001\002\000\004\002\006\001\002\000\004\002\001" +
    "\001\002\000\004\007\021\001\002\000\004\011\011\001" +
    "\002\000\004\014\012\001\002\000\004\016\013\001\002" +
    "\000\004\004\014\001\002\000\006\012\ufffe\016\ufffe\001" +
    "\002\000\004\016\016\001\002\000\004\015\017\001\002" +
    "\000\004\013\020\001\002\000\004\002\uffff\001\002\000" +
    "\004\014\022\001\002\000\004\016\023\001\002\000\004" +
    "\004\014\001\002\000\004\016\025\001\002\000\004\013" +
    "\026\001\002\000\004\004\014\001\002\000\004\012\030" +
    "\001\002\000\004\006\031\001\002\000\004\013\032\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$MeuParser$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // comando ::= ABRETAG HYPERLINK REFERENCE IGUAL ASPAS valor ASPAS FECHATAG valor ABRETAG CLOSEHYPER FECHATAG 
            {
              Object RESULT =null;

              CUP$MeuParser$result = parser.getSymbolFactory().newSymbol("comando",0, ((java_cup.runtime.Symbol)CUP$MeuParser$stack.elementAt(CUP$MeuParser$top-11)), ((java_cup.runtime.Symbol)CUP$MeuParser$stack.peek()), RESULT);
            }
          return CUP$MeuParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // comando ::= ABRETAG IMAGE SOURCE IGUAL ASPAS valor ASPAS CLOSEBAR FECHATAG 
            {
              Object RESULT =null;
          ...
          case 3: // valor ::= STRING 
            {
              ...
              CUP$MeuParser$result = parser.getSymbolFactory().newSymbol("valor",1, ((java_cup.runtime.Symbol)CUP$MeuParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$MeuParser$stack.peek()), RESULT);
            }
          return CUP$MeuParser$result;
